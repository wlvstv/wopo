 ...
 * The refresh token will need to be stored in devConfig, it's used to generate access tokens
 */
...
/* 
 * 'code' property is returned from calling a GET on the authorizeURL, this can
 * be done in Postman or curl or something, but here's the request format
 */
